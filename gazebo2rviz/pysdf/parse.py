...
from gazebo2rviz.pysdf.naming import *
from gazebo2rviz.pysdf.conversions import *

from gazebo2rviz.pysdf.conversions import pose_string2homogeneous, homogeneous2translation_rpy, rounded, array2string
...
def pose2origin(node, pose):
  ...
  ET.SubElement(node, 'origin', {'xyz': numpy.array2string(rounded(xyz)), 'rpy': array2string(rounded(rpy))})
